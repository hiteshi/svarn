...
<div class="heading"><li> E-Mail & SMS </li></div>
	<div class="subHeading"> 
		<div>
			<li><a href="/svarn/view/html/EnableMailSmsService.html" target="_blank">You can enable Mail/SMS Service</a></li>
		</div>
	</div>
<div class="heading"><li> Spot Us </li></div>
	<div class="subHeading"> 
		<div>
			<li><a href="/svarn/view/html/FindATM.html" target="_blank">Find nearest Branch</a></li>
		</div>
	</div>
