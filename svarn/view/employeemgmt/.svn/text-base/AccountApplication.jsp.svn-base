...
<title>AccountApplication</title>
...
$(document).ready(function(){
	...
	function xmlhttpPost(ii, id) 
	{
		...
		new Ajax.Request("/svarn/ApplicantDetails",
		{
				method: "post",
				parameters:"qq=" + ii,
	...
	function showTable()
	{
		...
		var ii=9;			
		new Ajax.Request("/svarn/ApplicantTable",
				{
				method: "post",
				parameters:"qq=" + ii,
...
<body onload="showTable()">
	<ol id="toc">
		<li  class="current"><a href="AccountApplication.jsp"><span>AccountApplication</span></a></li>
	...
	<div  id="applicationTable">
		<h2>AccountApplication</h2>
		<p>can approve the application</p>
		<p>can approve the application</p>
	</div>
	</td>
	...
	<input type="text" id="amount" name="initialAmount">
	<br />
	<br />
