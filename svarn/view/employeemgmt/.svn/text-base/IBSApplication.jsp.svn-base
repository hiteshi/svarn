...
$(document).ready(function(){
	...
	$("#approve").click(function(){
		...
		$.ajax({
			type: 'POST',
			url: '/svarn/approveIBS',
			data: "cid="+registrationId+'&acc='+account,
			dataType: 'html', 
		}).done(function(msg) {
	...
	function xmlhttpPost(ii,acc, id) 
	{
		registrationId=id;
		account=acc;
		
		//alert("for redistarityon id ================               "+selected+", "+registrationId);
		new Ajax.Request("/svarn/IBSDetails",
		{
				method: "post",
				parameters:"qq=" + ii,
	...
	function showTable()
	{
		...
		var ii=9;			
		new Ajax.Request("/svarn/IBSTable",
				{
				method: "post",
				parameters:"qq=" + ii,
...
<body onload="showTable()">
	<ol id="toc">
		...
		<li  class="current"><a href="IBSApplication.jsp"><span>IBSApplication</span></a></li>
