...
$(document).ready(function(){
	...
	$("#approve").click(function(){
		...
		$.ajax({
			type: 'POST',
			url: '/svarn/approveLoanApplicant',
			data: "cmd="+registrationId,
			dataType: 'html', 
		}).done(function(msg) {
	...
	//	alert("value of selected======================"+registrationId);
		$.ajax({
			type: 'POST',
			url: '/svarn/rejecteLoanApplicant',
			data: "cmd="+registrationId+'&selectedNo='+selected,
			dataType: 'html', 
		}).done(function(msg) {
	...
	function xmlhttpPost(ii, id) 
	{
		...
		new Ajax.Request("/svarn/LoanApplicantDetails",
		{
				method: "post",
				parameters:"qq=" + ii,
	...
	function showTable()
	{
		...
		var ii=9;			
		new Ajax.Request("/svarn/LoanApplicantTable",
				{
				method: "post",
				parameters:"qq=" + ii,
...
<body onload="showTable()">
	<ol id="toc">
		...
		<li class="current"><a href="LoanApplication.jsp"><span>LoanApplication</span>
		</a></li>
