...
<title>CompanyApplication</title>
...
$(document).ready(function(){
	...
	function xmlhttpPost(ii, id) 
	{
		...
		new Ajax.Request("/svarn/CompanyDetails",
		{
				method: "post",
				parameters:"qq=" + ii,
	...
	function showTable()
	{
		...
		var ii=9;			
		new Ajax.Request("/svarn/CompanyTable",
				{
				method: "post",
				parameters:"qq=" + ii,
...
<li><a href="AccountApplication.jsp"><span>AccountApplication</span></a></li>
		...
		<li  class="current"><a href="CompanyApplication.jsp"><span>CompanyApplication</span></a></li>
