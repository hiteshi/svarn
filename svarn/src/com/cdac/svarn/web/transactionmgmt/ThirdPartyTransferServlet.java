...
public class ThirdPartyTransferServlet extends BusinessServlet{
	...
	public void execute (HttpServletRequest requestObj, HttpServletResponse responseObj) throws ServletException, IOException
	{
		...
		System.out.println("3p servlet invoked ... ");
		...
		try{
			...
			System.out.println("now calling 3p transaction");
			
			
			boolean flag=false;
			flag = ft.partyLogic(accountFrom,accountTo,toChangeAmnt,remarks);
